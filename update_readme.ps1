# Script: update_readme.ps1
# Cria README.md profissional e faz push pro GitHub
...
# Escreve o README.md com UTF-8
$readmePath = 'C:\Dashboard_Frota_Dev\README.md'
$lines | Out-File $readmePath -Encoding utf8

Write-Host '[OK] README.md criado com sucesso!' -ForegroundColor Green

# Git add, commit, push
cd C:\Dashboard_Frota_Dev
git add README.md
git commit -m 'docs: README profissional com identidade MADEMAXI'
git push origin main

Write-Host '[OK] README atualizado no GitHub!' -ForegroundColor Green

# Auto-remove o script
